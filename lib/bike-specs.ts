...
export const FRAME_SIZES = ["XS", "S", "S/M", "M", "M/L", "L", "XL", "XXL", "Custom"];

export const WHEEL_SIZES = ["26\"", "27.5\"", "27.5+ (Plus)", "29\"", "700c", "650b", "24\"", "20\"", "16\""];

export const FRAME_MATERIALS = ["Carbon", "Aluminium", "Steel", "Titanium", "Chromoly"];

export const GROUPSET_BRANDS = ["Shimano", "SRAM", "Campagnolo", "microSHIFT", "Other"];
...
export const FORK_BRANDS = ["Fox", "RockShox", "Manitou", "Marzocchi", "DVO", "MRP", "X-Fusion", "SR Suntour", "Ohlins", "Other", "Rigid (no suspension)"];

export const SHOCK_BRANDS = ["Fox", "RockShox", "Ohlins", "Manitou", "X-Fusion", "DVO", "Other", "N/A (Hardtail)"];

export const MODEL_YEARS = Array.from({ length: 16 }, (_, i) => 2025 - i);
